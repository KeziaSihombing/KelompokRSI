    ...
    public void insertTable(){
        try {
            ...
            if(resultSet.next()){
               ...
               statement.executeUpdate("CREATE TABLE IF NOT EXISTS FAMIFY.KONTEN_VIDEO(ID_VIDEO INT NOT NULL AUTO_INCREMENT, JUDUL_VIDEO VARCHAR(100) NOT NULL, DESKRIPSI TEXT NOT NULL, PENGUN GGAH VARCHAR(100) NOT NULL, VIDEO LONGBLOB NOT NULL, TANGGAL_PUBLIKASI DATE NOT NULL,THUMBNAIL MEDIUMBLOB NOT NULL, PRIMARY KEY(ID_VIDEO))");
