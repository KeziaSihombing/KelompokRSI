    ...
    public void insertTable(){
        try {
            ...
            if(resultSet.next()){
               ...
               statement.executeUpdate("CREATE TABLE IF NOT EXISTS FAMIFY.KONTEN_VIDEO(ID_VIDEO INT NOT NULL, JUDUL_VIDEO VARCHAR(100) NOT NULL, DESKRIPSI TEXT NOT NULL, PENGUNGGAH VARCHAR(100) NOT NULL, VIDEO LONGBLOB NOT NULL, TANGGAL_PUBLIKASI DATE NOT NULL,THUMBNAIL MEDIUMBLOB NOT NULL, PRIMARY KEY(ID_VIDEO))");
               statement.executeUpdate("CREATE TABLE IF NOT EXISTS FAMIFY.KONTEN_ARTIKEL(ID_ARTIKEL INT NOT NULL AUTO_INCREMENT, JUDUL_ARTIKEL VARCHAR(100) NOT NULL, SUBJUDUL VARCHAR(100) NOT NULL, ISI_ARTIKEL TEXT NOT NULL, PENULIS VARCHAR(100) NOT NULL, TANGGAL_PUBLIKASI DATE NOT NULL, THUMBNAIL MEDIUMBLOB NOT NULL, PRIMARY KEY(ID_ARTIKEL))");
