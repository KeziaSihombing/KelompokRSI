    ...
    public void insertTable(){
        try {
            ...
            if(resultSet.next()){
               ...
               statement.executeUpdate("CREATE TABLE IF NOT EXISTS FAMIFY.KONSULTAN (ID_KONSULTAN INT NOT NULL AUTO_INCREMENT,NAMA_KONSULTAN VARCHAR(100) NOT NULL,EMAIL VARCHAR(100) NOT NULL, USERNAME VARCHAR(50) NOT NULL, PASSWORD VARCHAR(50) NOT NULL,PRIMARY KEY (ID_KONSULTAN))");
               ...
               statement.executeUpdate("CREATE TABLE IF NOT EXISTS FAMIFY.HASIL_KONSULTASI (ID_HASIL INT NOT NULL AUTO_INCREMENT, ID_RESERVASI INT NOT NULL,CATATAN_KONSULTASI BLOB NOT NULL,PRIMARY KEY (ID_HASIL),FOREIGN KEY (ID_RESERVASI) REFERENCES FAMIFY.RESERVASI (ID_RESERVASI))");
