    ...
    public void insertTable(){
        try {
            ...
            if(resultSet.next()){
               ...
               statement.executeUpdate("INSERT INTO FAMIFY.KONSULTAN (NAMA_KONSULTAN, EMAIL, USERNAME, PASSWORD, SPESIALISASI) VALUES ('Kathryn Murphy', 'kathrynmurphy@gmail.com', 'kathryn_murphy', 'konsultan2')");
