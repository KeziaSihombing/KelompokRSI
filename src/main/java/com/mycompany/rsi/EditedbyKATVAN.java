 ...
 * @author HP
 */
public class EditedbyKATVAN extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (fileName.endsWith(".pdf")){
            ...
            // pesan error dari pop up
            Aplikasi.dialogUI.showMessage("error");
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (jButton3.getText().equals("Simpan")){
            if (filePath.endsWith(".pdf")){
                // confirm simpen
                int response = javax.swing.JOptionPane.showConfirmDialog(this, "Konfirmasi penyimpanan file hasil konsultasi?", "Konfirmasi", javax.swing.JOptionPane.YES_NO_OPTION);
                //simpen ke db
                if (response == javax.swing.JOptionPane.YES_OPTION) {
                File file = new File(filePath);
                simpanDB(file);}
            }else{
               javax.swing.JOptionPane.showMessageDialog(this, "Format file tidak didukung", "Error", javax.swing.JOptionPane.ERROR_MESSAGE); 
            } //hapus dari db
    ...
    private void simpanDB(File file){
        ...
        String query = "INSERT INTO HASIL_KONSULTASI (ID_HASIL, FILE_KONSULTASI) VALUES (?, ?)";
        PreparedStatement pstmt = con.prepareStatement(query);
        int row = pstmt.executeUpdate();
        if (row>0) {
            //ubah label jadi hapus
            javax.swing.JOptionPane.showMessageDialog(this, "File hasil konsultasi berhasil disimpan");
    ...
    try {
        ...
        // Query untuk menghapus file berdasarkan ID hasil konsultasi
        String query = "DELETE FROM HASIL_KONSULTASI WHERE ID_HASIL = ?";
        PreparedStatement pstmt = con.prepareStatement(query);
        
        int row = pstmt.executeUpdate();
        
        if (row > 0) {
            javax.swing.JOptionPane.showMessageDialog(this, "File hasil konsultasi berhasil dihapus");
        }
    ...
    try {
        Aplikasi.database.databaseConnection();
        conn = Aplikasi.database.getCon();
        
        // Query untuk memeriksa apakah file sudah ada di database
        String query = "SELECT FILE_KONSULTASI FROM HASIL_KONSULTASI WHERE ID_HASIL = ?";
        pstmt = conn.prepareStatement(query);
        
        rs = pstmt.executeQuery();
        
        if (rs.next()) {
            // Jika file ada, ubah tombol
            jButton1.setText("Lihat File Hasil Konsultasi");
            jButton3.setText("Hapus");
        } else {
            // Jika file tidak ada, biarkan tombol upload
            jButton1.setText("+ Unggah Hasil Konsultasi");
            jButton3.setText("Simpan");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpHasilKonsultasiUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpHasilKonsultasiUI().setVisible(true);
            }
        });
    }
